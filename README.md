...
[travis-badge]: https://travis-ci.org/filipesilva/angular-toxic-infinite-scroller.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-toxic-infinite-scroller
...
1. Create a project folder (you can call it `toxic-infinite-scroller` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-toxic-infinite-scroller.git
cd angular-toxic-infinite-scroller
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-toxic-infinite-scroller/archive/master.zip)
...
Use your editor to search the project for all instances of `angular-toxic-infinite-scroller` and change it
